...
<div class="container">
    ...
    <div class="pb-2 mt-4 mb-2 border-bottom">
        <h1>Report ore clienti</h1>      
    </div>

    <p class="lead">Seleziona due date per vedere il totale delle ore spese per ogni cliente in un determinato periodo</p>
    ...
    <p class="lead">Totale delle ore spese per ogni cliente questo mese</p>  
